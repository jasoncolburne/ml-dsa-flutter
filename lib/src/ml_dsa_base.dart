...
class MLDSA {
  ...
  Future<(Uint8List, Uint8List)> keyGenWithSeed(Uint8List rnd) async {
    return _keyGen(rnd);
  }

  Future<Uint8List> sign(Uint8List sk, Uint8List message, Uint8List ctx) async {
    if (ctx.length > 255) {
  ...
  Future<Uint8List> signDeterministically(
