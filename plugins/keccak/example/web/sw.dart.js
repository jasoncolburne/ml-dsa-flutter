...
(function dartProgram() {
        ...
        if ((t2 & 1) === id) {
          ...
          if ((t2 & 4) !== 0) {
            ...
            if (next0 == null)
              ...
              next0.set$_async$_previous(previous);
            subscription.set$_async$_previous(subscription);
            subscription.set$_async$_next(subscription);
          }
  ...
  A.KeccakHash.prototype = {
    ...
    $$finalize$0() {
      ...
      if (t1 <= _this.stateSize)
        return new Uint8Array(t2.subarray(0, A._checkValidRange(0, t1, t3)));
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var instance, instanceId, data, t3, t4, t5, stateSize, bytes, _s4_ = "type", _s2_ = "id",
        _s8_ = "instance",
        t1 = type$.ExtendableMessageEvent._as($event)._delegate,
        parsedData = B.C_JsonCodec.decode$1(0, A._asString(t1.data)),
        t2 = J.getInterceptor$asx(parsedData);
      if (J.$eq$(t2.$index(parsedData, _s4_), "createRequest")) {
        instance = A.KeccakHash$(null, 31, 32);
        instanceId = $._nextKeccakInstance;
        $._nextKeccakInstance = instanceId + 1;
        $._keccakInstances.$indexSet(0, instanceId, instance);
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t2.$index(parsedData, _s2_), "type", "createResponse", "instance", instanceId], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
      if (J.$eq$(t2.$index(parsedData, _s4_), "freeRequest")) {
        $._keccakInstances.$index(0, t2.$index(parsedData, _s8_)).toString;
        $._keccakInstances.remove$1(0, t2.$index(parsedData, _s8_));
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t2.$index(parsedData, _s2_), "type", "freeResponse"], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
      if (J.$eq$(t2.$index(parsedData, _s4_), "initializeRequest")) {
        t3 = $._keccakInstances.$index(0, t2.$index(parsedData, _s8_));
        t3.toString;
        A._asInt(t2.$index(parsedData, "rate"));
        t4 = A._asInt(t2.$index(parsedData, "capacity"));
        A._asInt(t2.$index(parsedData, "hashBitLen"));
        t5 = A._asInt(t2.$index(parsedData, "delimitedSuffix"));
        stateSize = B.JSInt_methods._shrOtherPositive$1(t4, 4);
        t3.hashLength = t3.stateSize = stateSize;
        t3.blockLength = 200 - (stateSize << 1 >>> 0);
        t3.paddingByte = t5;
        t5 = t3.buffer;
        B.NativeUint8List_methods.fillRange$3(t5, 0, t5.length, 0);
        t3.__KeccakHash_squeezing_A = false;
        t3.super$BlockHashSink$reset(0);
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t2.$index(parsedData, _s2_), "type", "initializeResponse"], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
      if (J.$eq$(t2.$index(parsedData, _s4_), "absorbRequest")) {
        t3 = $._keccakInstances.$index(0, t2.$index(parsedData, _s8_));
        t3.toString;
        t3.add$1(0, new Uint8Array(A._ensureNativeList(B.C_Base64Decoder.convert$1(A._asString(t2.$index(parsedData, "message"))))));
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t2.$index(parsedData, _s2_), "type", "absorbResponse"], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
      if (J.$eq$(t2.$index(parsedData, _s4_), "squeezeRequest")) {
        t3 = $._keccakInstances.$index(0, t2.$index(parsedData, _s8_));
        t3.toString;
        bytes = t3.squeeze$1(A._asInt(t2.$index(parsedData, "bytesToSqueeze")) * 8);
        t3 = t2.$index(parsedData, _s2_);
        type$.Base64Codec._eval$1("Codec.S")._as(bytes);
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t3, "type", "squeezeResponse", "bytes", B.C_Base64Codec.get$encoder().convert$1(bytes)], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
      if (J.$eq$(t2.$index(parsedData, _s4_), "sha3512Request")) {
        t3 = new Uint8Array(A._ensureNativeList(B.C_Base64Decoder.convert$1(A._asString(t2.$index(parsedData, "message")))));
        instance = A.KeccakHash$(64, 6, 64);
        instance.add$1(0, t3);
        bytes = instance.$$finalize$0();
        t2 = t2.$index(parsedData, _s2_);
        type$.Base64Codec._eval$1("Codec.S")._as(bytes);
        data = A.LinkedHashMap_LinkedHashMap$_literal(["id", t2, "type", "sha3512Response", "bytes", B.C_Base64Codec.get$encoder().convert$1(bytes)], type$.String, type$.dynamic);
        new A.ServiceWorkerClient(type$.Object._as(t1.source)).postMessage$1(0, B.C_JsonCodec.encode$1(data));
      }
    },
    $signature: 15
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "service_worker_api_ExtendableMessageEvent_____tearOff$closure", "ExtendableMessageEvent_____tearOff", 16);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.assertInteropArgs_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._SyncBroadcastStreamController__sendData_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.main_closure, A.callbackToStream_closure]);
...
;
  ...
  (function staticFields() {
    ...
    $._nextKeccakInstance = 0;
    $._keccakInstances = A.LinkedHashMap_LinkedHashMap$_empty(type$.int, A.findType("KeccakHash"));
  })();
